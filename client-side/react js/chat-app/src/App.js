      ...
      <div className='container'>
        <div className='row'>
          <div className='col-md-6 offset-md-3 col-sm-12'>
            <h1 class="text-center">welecome to Chat application</h1>
            <div>
              <input type="text" v-model="name" onChange={e => setUserName(e.target.value)} id="username" class="form-control" placeholder="Enter name..." />
            </div>
            <div class="card">
              <div id="mass" class="card-block" >
                {messageData.map((data, index) =>
                (
                  <div className='dropdown'>
                    <div class="card"  id={data.id} style={{ color: data.color,display:'flex' }}>
              ...
              <textarea class="form-control" value={message} onChange={e => setMessage(e.target.value)} placeholder="Enter message..."></textarea>
              <button class="btn" onClick={handleSubmitNewMessage}>Send</button>
              <div></div>
            </div>
          </div>
        </div>
